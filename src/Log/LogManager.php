...
namespace Wxm\Venomancer\Log;

use Wxm\Venomancer\Container;
...
class LogManager implements LoggerInterface
{
     ...
     *
     * @param \Wxm\Venomancer\Container $app
     */
    ...
    protected function createEmergencyLogger()
    {
        return new Monolog(
            ...
            $this->prepareHandlers([
                new StreamHandler(
                    \sys_get_temp_dir() . '/venomancer.log',
